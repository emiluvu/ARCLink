...
func localized(_ text: String, _ language: AppLanguage) -> String {
    ...
    let translations: [String: String] = [
        ...
        "Connection": "Conexión",
        "Air Quality Data": "Datos de calidad del aire",
        "Use this screen to confirm the Raspberry Pi is sending carbon, temperature, and humidity JSON over Bluetooth.": "Usa esta pantalla para confirmar que la Raspberry Pi está enviando JSON de carbono, temperatura y humedad por Bluetooth.",
        "Last Sensor Update": "Última actualización del sensor",
        "No sensor data has been received yet.": "Todavía no se han recibido datos del sensor.",
        "Request Latest Air Quality Reading": "Solicitar la lectura más reciente de calidad del aire",
        "Sensor Readings": "Lecturas del sensor",
        "Carbon": "Carbono",
        "Temperature": "Temperatura",
        "Humidity": "Humedad",
        "Unavailable": "No disponible",
        "JSON received, but the expected air quality keys were not found.": "Se recibió JSON, pero no se encontraron las claves esperadas de calidad del aire.",
        "Raw JSON": "JSON sin procesar",
        "No JSON payload received yet.": "Todavía no se ha recibido ninguna carga JSON.",
        "Requested the latest air quality reading from the Raspberry Pi.": "Se solicitó la lectura más reciente de calidad del aire desde la Raspberry Pi.",
        "Connected device is missing the Bluetooth characteristic.": "Al dispositivo conectado le falta la característica de Bluetooth.",
        "Failed to request air quality data.": "No se pudieron solicitar los datos de calidad del aire.",
