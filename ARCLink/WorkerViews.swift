    ...
    public var body: some View {
        List {
            ...
            Section("Siri & Shortcuts") {
                Text("Use Siri or the Shortcuts app to run ARCLink actions.")
                    .font(.caption)
                    .foregroundStyle(.secondary)
                ShortcutsLink()
            ...
            Section("Translation") {
                VStack(alignment: .leading, spacing: 6) {
                    Text("English → Spanish")
                        .font(.subheadline.weight(.semibold))
                    Text("Translate phrases by typing or speaking, and hear the result in Spanish.")
                        .font(.caption)
                        .foregroundStyle(.secondary)
                }
                .padding(.vertical, 2)
                ...
                NavigationLink {
                    ...
                    Label("Open Translator", systemImage: "character.bubble.fill")
                        .foregroundStyle(Color.arcAccentOrange)
                }

                SiriTipView(intent: TranslateToSpanishIntent(), isVisible: .constant(true))
            }
